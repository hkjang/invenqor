<div class="document-cover">
  ...
  <h1>임원 보고서</h1>
  <p class="subtitle">Linux·Windows 자산과 주요 소프트웨어 가시성 확보를 위한 Agent v0.2.34·Server v0.2.34 도입 가치, 통제 경계와 단계별 확산 제안</p>
  <div class="meta">
    <p><strong>대상 릴리즈</strong> Agent v0.2.34 · Server v0.2.34</p>
...
## v0.2.34 주요 소프트웨어 Intelligence 확장 요약
...
v0.2.34는 프로세스를 많이 수집하고도 “어떤 주요 제품을 관리하는가”에 답하기
...
Invenqor Agent v0.2.34는 Linux 서버와 Windows PC·서버의 운영체제, 하드웨어 자원, 네트워크,
...
산출해야 합니다. v0.2.34 자료만으로 절감액이나 ROI를 단정하지 않습니다.

## 6. 위험과 통제 계획

### 6.1 주요 위험

| 위험 | 영향 | v0.2.34 상태 | 필수 통제 |
|---|---|---|---|
...
Agent v0.2.34·Server v0.2.34는 동일 commit에서 다음 자동 검증이 모두 성공한
경우에만 릴리즈합니다.
...
Invenqor Agent v0.2.34는 Linux·Windows 자산 가시성의 가장 아래층인 **현장
