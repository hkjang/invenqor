...
이 디렉터리는 Invenqor Server v0.2.8와 Agent v0.2.8의 역할별 공식 가이드를 제공합니다.
...
변경 요약과 검증 증적은 [Server v0.2.8 릴리즈 노트](RELEASE_NOTES_v0.2.8.md)를
참조하십시오.

문서의 기준 릴리즈는 Server `v0.2.8`, Agent `v0.2.8`, 기준일은
