...
이 디렉터리는 Invenqor Server v0.2.35와 Agent v0.2.35의 역할별 공식 가이드를 제공합니다.
...
변경 요약과 검증 증적은 [Server·Agent v0.2.35 릴리즈 노트](RELEASE_NOTES_v0.2.35.md)를
참조하십시오.

문서의 기준 릴리즈는 Server `v0.2.35`, Agent `v0.2.35`, 기준일은
2026-08-24입니다. 제품 동작과
문서가 다를 경우 해당 버전의 소스 코드와 설정 검증 결과를 우선하며, 문서 오류는
저장소 이슈로 보고해 주십시오.

v0.2.35는 URL-only Agent 등록과 Windows 자동 업데이트를 강화하고, 사용자별
