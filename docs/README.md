...
이 디렉터리는 Invenqor Server v0.2.5와 Agent v0.2.3의 역할별 공식 가이드를 제공합니다.
...
변경 요약과 검증 증적은 [Server v0.2.5 릴리즈 노트](RELEASE_NOTES_v0.2.5.md)를
참조하십시오.

문서의 기준 릴리즈는 Server `v0.2.5`, Agent `v0.2.3`, 기준일은
