...
ALTER TABLE api_keys ADD COLUMN previous_valid_until TIMESTAMPTZ;
ALTER TABLE api_keys ADD COLUMN updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP;
